...
A **Setup** is also available [here](https://www.dropbox.com/s/zkosbebcs33e8b1/Setup_ComMonitor_x32_1_1_0_32431.zip?dl=0) NOTE: Both the ComMonitor.exe and the Setup*.exe is not signed.
