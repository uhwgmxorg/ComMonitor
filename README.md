...
A **Setup** is also available [here](https://www.dropbox.com/s/9wl3f8jhce5r6dv/Setup_ComMonitor_x32_1_1_0_32431.zip?dl=0) NOTE: Both the ComMonitor.exe and the Setup*.exe is not signed.
